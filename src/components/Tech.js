...
const Tech = () =>{
        ...
        const part = (techImages.slice(start, finish).map( (tI, i) =>(<span className="d-flex flex-column"><div className="mx-auto" key={i}><img src={tI.img} alt={tI.alt} height="200px" width="200px" /></div></span>)))
                return part
            }
